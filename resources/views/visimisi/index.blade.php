...
<div class="p-5 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <div class="card flex-col flex-md-row  p-2 mb-4">
        <img class="image-responsive w-100" src="{{asset('img/visi1.jpg')}}" alt="Visi Image">
        <div class="card-body">
